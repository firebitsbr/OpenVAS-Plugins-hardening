...
script_version("1.0");
name["english"] = "NAME-4206-Linux - Verificar por status do daemon BIND está em execução";
...
if ( soc )
{
	...
	cmd000=ssh_cmd(socket:soc, cmd:"/usr/sbin/named /etc/named ; echo $?");	

	display("Exibindo evidência(s) do Arquivo de Configuração do BIND está consistente.\n");
	display(cmd000);
