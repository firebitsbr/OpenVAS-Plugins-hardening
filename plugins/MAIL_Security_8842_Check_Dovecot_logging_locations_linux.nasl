...
script_version("1.0");
name["english"] = "MAIL-8842-Linux - Check Dovecot logging locations";
...
if ( soc )
{
	...
	display("Check Dovecot logging locations\n");
	cmd000=ssh_cmd(socket:soc, cmd:"cat /etc/dovecot/dovecot.conf | grep "^log_path" | awk '{ if ($1=="") { print "syslog" } else { print $3 } }'");	
